// CS 1501
// Simple test program to demonstrate DictInterface and its implementations.  Note
// that the variable is type DictInterface but the object could be a MyDictionary
...
// object but in Part B you will create a DLB which should be a much more efficient
// implementation of the DictInterface.  The output to this program should be
// identical with both objects.
